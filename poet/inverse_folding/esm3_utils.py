"""Utils for ESM3 geometric attention input processing."""
...
def fp32_autocast_context(device_type: str) -> T.ContextManager[torch.amp.autocast]:  # type: ignore
    """
...
def extract_coords_from_pdb(pdb_path: str | Path, chain: str = "A") -> torch.Tensor:
    coords = load_coords(str(pdb_path), chain)[0]
